...
address="https://192.168.104.98:8080/video"
...
def call():
    account_sid='AC4620fc7903a0428f3815deb15647d8bb'
    auth_token='19598841b0bf0961546912ee00320134'
    client=Client(account_sid,auth_token)
    call=client.calls.create(
        twiml='<Response><Say>jgjgjgjgjgjgjgjh</Say></Response>',
        to='+917305499660',
        from_='+13022400816' )
    print(call.sid)
